...
export default MealDetails = props => {
  ...
  return(
    <ScrollView>
      ...
      { selectedMeal.ingredients.map((ingredient, idx) => <ListItem style={styles.title} key={idx}>{ingredient}</ListItem>) }
      
      <Text style={styles.title}>Steps</Text>
      { selectedMeal.steps.map((step, idx) => <ListItem style={styles.title} key={idx}>{step}</ListItem>)}
